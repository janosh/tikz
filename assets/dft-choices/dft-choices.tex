...
\begin{tikzpicture}[auto]
  ...
  \node [c,above=of kinetic,xshift=5em] (kinetic comment) {nonrel. Schrödinger equation\\or relativistic Dirac equation};
  \node [c,below=of external,xshift=-10em] (external comment) {crystal ions or\\pseudopotential};
  \node [c,below=of hartree,xshift=5em] (hartree comment) {Poisson equation\\or equation \cref{eqn:hartree potential}};
