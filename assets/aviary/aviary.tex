% Logo for the ML lib "Aviary": representation learning from stoichiometry + symmetries via graph convolutions.
% https://github.com/CompRhys/aviary (not created yet)
% or https://github.com/janosh/aviary
