...
\tikzset{atom/.style={circle, shading=atomshade, minimum size=0.4cm},
   bond/.style={
        line width=0.5mm,
        shading=axis,
...
\newcommand{\DrawUnitCell}[1]{
    ...
    % If you want arrow indicating Ti polarization
    %\ifnum \pdfstrcmp{#1}{0.5} > 0
    %    \draw[->, thick] (0.5,{#1},0.5) -- ++(0,0.3,0);
    %\else\ifnum \pdfstrcmp{#1}{0.5} < 0
    %    \draw[->, thick] (0.5,{#1},0.5) -- ++(0,-0.3,0);
    %\fi\fi
