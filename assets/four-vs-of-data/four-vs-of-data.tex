% Inspired by fig. 1 in https://api.semanticscholar.org/CorpusID:137734316.

\documentclass[tikz, border=0 2]{standalone}
...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(\s,\s)}]
    ...
    \draw[direction] (0:\rB) arc(0:90:\rB) node[pos=0.05, above right] {reference data} node[pos=0.95, above right] {high variance};
  \end{scope}
