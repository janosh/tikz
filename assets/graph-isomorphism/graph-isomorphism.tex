% Graphs can look differently but be identical. The only thing that matters are which
% nodes are connected to which other nodes. If there exists a bijection between the nodes
% of graph 1 and graph 2 such that the set of connections for each nodes remain identical,
