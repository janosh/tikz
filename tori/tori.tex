...
\begin{tikzpicture}
  \tikzset{
    ...
    vec/.style={ultra thick,-latex,DarkBlue}}
  ...
  \begin{scope}
    ...
    \draw [vec] (origin) -- (\gridscale,0) node [label,right=3] {$2 \pi \vec{u}$};
    \draw [vec] (origin) -- (0,\gridscale) node [label,above=3] {$2 \pi \vec{v}$};
    \draw [vec] (origin) -- (\gridscale,\gridscale) node [label,right=3] {$2 \pi (\vec{u} + \vec{v})$};
  ...
  \begin{scope}[xshift=2*\xmax cm]
    ...
    \draw [vec] (origin) -- (\gridscale,0) node [label,below=3] {$2 \pi$};
    \draw [vec] (origin) -- (0,\gridscale) node [label,above=3] {$2 \pi \vec{v}$};
    \draw [vec] (origin) -- (\gridscale,\gridscale) node [label,right=3] {$2 \pi [(1,0) + \vec{v}]$};
    \filldraw[fill=gray,fill opacity=0.3] (origin) rectangle (\gridscale,\gridscale);
  \end{scope}
\end{tikzpicture}
\end{document}